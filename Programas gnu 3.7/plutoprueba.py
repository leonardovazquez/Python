...
# Title: pluto_prueba_3_7
# Author: Leonardo David Vazquez
# Generated: Mon Dec  6 14:03:17 2021
##################################################
...
class plutoprueba(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "pluto_prueba_3_7")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("pluto_prueba_3_7")
        ...
        self.settings = Qt.QSettings("GNU Radio", "plutoprueba")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 2804000
        ...
        self.pluto_sink_0 = iio.pluto_sink('usb:1.8.5', 2400000000, 2084000, 20000000, 0x8000, True, 1, '', True)
...
def main(top_block_cls=plutoprueba, options=None):
